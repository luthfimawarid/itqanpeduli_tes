<div class="bg-green-700 px-4 pt-4 pb-20">
    ...
    <button type="button"
        ...
        <svg class="w-14 h-14  me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 104 102" fill="none">
            <g filter="url(#filter0_dd_781_1053)">
                ...
                <rect x="83.25" y="67.25" width="14.5" height="28.5" rx="2.75" fill="#FBC71E" stroke="black"
                    stroke-width="2.5" />
                <rect x="27.25" y="19.25" width="64.5" height="33.5" rx="1.75" fill="#FBC71E" stroke="black"
                    stroke-width="2.5" />
                ...
                <rect x="6.25" y="6.25" width="14.5" height="28.5" rx="2.75" fill="#077734" stroke="black"
                    stroke-width="2.5" />
            </g>
            <defs>
                <filter id="filter0_dd_781_1053" x="0" y="0" width="104" height="102" filterUnits="userSpaceOnUse"
    ...
    <button type="button"
        ...
        <svg class="w-14 h-14  me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 30" fill="none">
            ...
            <path
                d="M6.30176 17.6788C6.30176 17.6634 6.31425 17.6509 6.32966 17.6509H30.9714C30.9868 17.6509 30.9993 17.6634 30.9993 17.6788V27.6973C30.9993 28.1597 30.6245 28.5346 30.1621 28.5346H7.13896C6.67659 28.5346 6.30176 28.1597 6.30176 27.6973V17.6788Z"
                fill="#077734" stroke="black" stroke-width="1.11627" mask="url(#path-2-inside-1_783_1325)" />
    ...
    <button type="button"
        ...
        <div class="kiri">
            ...
            <svg width="125" height="35" viewBox="0 0 125 35" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <mask id="mask0_1381_1548" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="125"
                    height="35">
