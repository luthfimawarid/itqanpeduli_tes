    ...
    <div class="p-4 bg-white">
        ...
        <div class=" isi mt-10">
            ...
            <form action="" class="mt-8">
                ...
                <div class="relative mt-6">
                    <label for="password1"
                        class="absolute -top-3 left-3 bg-white px-1 font-semibold text-sm text-gray-600">Kata sandi <span class="text-yellow-500">* silahkan diisi jika ingin mengganti password</span></label>
