...
@section('content')
    <div class="p-4 sm:ml-80">
        <div class="header flex justify-between mt-3">
            <div class="kiri">
                <p class="text-2xl font-semibold">Kelola Kegiatan</p>
            </div>
            <div class="kanan">
            ...
            <form class="px-8 mt-6 bg-white rounded-lg">
                ...
                <div class=" pt-4">
                    <label class="block mb-2 text-sm font-medium text-black dark:text-white"
                        for="foto">Foto
                        <p class="text-yellow-500">kegiatan image recommendation 575x575px</p>
                    </label>
                    <input
                ...
                <div class=" pt-4">
                    <label for="CTA" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CTA (call to action)</label>
                    <input type="text" id="CTA"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Name Button CTA" required />
                </div>
                <div class=" pt-4">
                    <label for="direct_link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Direct Link</label>
                    <input type="text" id="direct_link"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Direct Link" required />
                </div>
