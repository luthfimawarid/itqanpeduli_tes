...
@section('content')
    <div class="p-4 sm:ml-80">
        <div class="header flex justify-between mt-3">
            <div class="kiri">
                <p class="text-2xl font-semibold">Kelola Kategori</p>
            </div>
            <div class="kanan">
        ...
        <div class="subheader text-white my-8">
            ...
            <form class="px-8 mt-6 bg-white rounded-lg">
                <div class=" pt-4">
                    <label for="kelola_kategori" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelola Kategori</label>
