...
@section('content')
    <div class="p-4 sm:ml-80">
        <div class="header flex justify-between mt-3">
            <div class="kiri">
                <p class="text-2xl font-semibold">Google Analytics</p>
            </div>
            <div class="kanan">
        ...
        <div class="subheader text-white my-8">
            <div class="welcome  bg-green-700 me-30 w-full py-6 px-2 rounded-xl">
                <div class="kanan ">
                    <p class="text-white px-2 text-2xl font-semibold">Google Analytics</p>
                    <p class="text-gray-300 px-2 text-lg">tambahkan google analytics ke website anda</p>
                </div>
            </div>
            <form class="px-8 mt-6 bg-white rounded-lg">
                <div class=" pt-4">
                    <label for="id_pelacakan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Pelacakan (Tracking ID)</label>
                    <input type="text" id="id_pelacakan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="ID Pelacakan" required />
                </div>
