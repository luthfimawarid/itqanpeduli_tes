...
@section('content')
    <div class="p-4 sm:ml-80">
        <div class="header flex justify-between mt-3">
            <div class="kiri">
                <p class="text-2xl font-semibold">Program Wakaf</p>
            </div>
            <div class="kanan">
        ...
        <div class="subheader text-white my-8">
            ...
            <form class="px-8 mt-6 bg-white rounded-lg">
                ...
                <div class="pt-4">
                    ...
                    <input
                        class="block  text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 "
                ...
                <div class="pt-4">
                    <label for="labelDonasi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Satuan / Unit</label>
                    <input type="text" id="labelDonasi"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="misal: m2/m/kg/dll" required />
                </div>
                <div class="pt-4">
                    <label for="labelDonasi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga per Unit</label>
                    <input type="text" id="labelDonasi"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded- mdfocus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <input type="text" id="labelDonasi"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Wakaf Sekarang" required />
                ...
                <div class="flex">
                    ...
                    <p class="bg-gray-200 border w-8 px-auto rounded-r-md text-center border-gray-300 text-black">%</p>
                </div>
