                ...
                <div class="kanan">
                    <form class="flex items-center max-w-sm mx-auto">   
                        ...
                        <div class="relative w-full">
                            <input type="text" id="simple-search" class="h-8 bg-gray-50 border border-green-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 block w-full ps-2 p-2  dark:bg-gray-700 dark:border-green-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-800 dark:focus:border-green-800" required />
                        </div>
                    </form>
                </div>
            </div>
